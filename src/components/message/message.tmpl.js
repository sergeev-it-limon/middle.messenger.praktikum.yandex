...
var pug_match_html=/["&<>]/;export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (style) {
      pug_html = pug_html + "\u003Csection data-state=\"class:className\"\u003E\u003Carticle data-state=\"text\"\u003E\u003C\u002Farticle\u003E\u003Ctime" + (pug_attr("class", pug_classes([style.time], [true]), false, false)+" data-state=\"time\"") + "\u003E\u003C\u002Ftime\u003E\u003C\u002Fsection\u003E";
