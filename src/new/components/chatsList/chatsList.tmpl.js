...
pug_html = pug_html + "\u003Chr" + (pug_attr("class", pug_classes([style.divider], [true]), false, false)) + "\u002F\u003E\u003Cdiv" + (pug_attr("class", pug_classes([style.itemWrapper], [true]), false, false)+pug_attr("data-parent-for", 'item_'+id, true, false)) + "\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
