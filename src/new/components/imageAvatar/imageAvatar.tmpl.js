...
var pug_match_html=/["&<>]/;export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (alt, src, style) {
      pug_html = pug_html + "\u003Cfigure" + (pug_attr("class", pug_classes([style.root], [true]), false, false)) + "\u003E\u003Cimg" + (pug_attr("class", pug_classes(["imageAvatar__image",style.image], [false,true]), false, false)+pug_attr("src", src, true, false)+pug_attr("alt", alt, true, false)) + "\u002F\u003E\u003C\u002Ffigure\u003E";
